...
describe('Auth Routes', () => {
    ...
    describe('POST /auth/register', () => {
        ...
        it('should return 400 for password without uppercase letter', async () => {
            ...
            assert.strictEqual(response.status, 400);
            assert(response.body.details.some((msg) => msg.includes('uppercase')));
        });
        it('should return 400 for password without number', async () => {
            ...
            assert.strictEqual(response.status, 400);
            assert(response.body.details.some((msg) => msg.includes('number')));
        });
        it('should return 400 for password shorter than 8 characters', async () => {
            ...
            assert.strictEqual(response.status, 400);
            assert(response.body.details.some((msg) => msg.includes('8 characters')));
        });
