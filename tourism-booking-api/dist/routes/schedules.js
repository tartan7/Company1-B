...
router.get('/summaries/by-activity/:activityId', async (req, res) => {
    try {
...
router.get('/summaries/activities', async (req, res) => {
    try {
...
router.patch('/:id', verifyToken, requireOperator, async (req, res) => {
    try {
        const input = req.body;
