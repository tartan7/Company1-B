import { pgTable, bigint, varchar, text, date, integer, boolean, timestamp, numeric, index, check, uniqueIndex, foreignKey } from 'drizzle-orm/pg-core';
...
export const userPleasanterMappings = pgTable('user_pleasanter_mappings', {
    id: bigint('id', { mode: 'bigserial' }).primaryKey(),
...
export const tenantMappings = pgTable('tenant_mappings', {
    id: bigint('id', { mode: 'bigserial' }).primaryKey(),
...
export const syncReconciliationLogs = pgTable('sync_reconciliation_logs', {
    id: bigint('id', { mode: 'bigserial' }).primaryKey(),
    organizationId: bigint('organization_id', { mode: 'bigint' }).notNull(),
