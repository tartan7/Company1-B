...
const localToUtcResult = measurePerformance(
  'Convert local → UTC',
  () => {
...
const utcToLocalResult = measurePerformance(
  'Convert UTC → local',
  () => {
...
const fullConversionResult = measurePerformance(
...
const roundTripResult = measurePerformance(
...
const multiTzResult = measurePerformance(
  'Multi-timezone batch',
  () => {
...
const dateFormatsResult = measurePerformance(
  'Varied date formats',
  () => {
...
const dstResult = measurePerformance(
...
const worstCaseResult = measurePerformance(
  'Random timezone conversion',
  () => {
